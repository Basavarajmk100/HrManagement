...
const InsurancePage = () => {
  ...
  const [showPlanAInfo, setShowPlanAInfo] = useState(false);
        ...
        <form onSubmit={handleSubmit} className="insurance-form-grid">
          ...
          <div className="form-section">
            ...
            <input
              ...
              value={employeeData.child1Gender}
              onChange={handleChange}
            />
            <input
              type="date"
              name="child1Dob"
              value={employeeData.child1Dob}
              onChange={handleChange}
            />
            ...
            <input
              ...
              value={employeeData.child2Gender}
              onChange={handleChange}
            />
            <input
              type="date"
              name="child2Dob"
              value={employeeData.child2Dob}
              onChange={handleChange}
            />
          </div>
          ...
          <div className="form-section">
            ...
            <label>
              <input
                type="checkbox"
                name="planAChecked"
                checked={employeeData.planAChecked}
                onChange={handleChange}
              />
              Plan A
            </label>
            ...
            <a
              href="#"
              style={{ marginLeft: "10px", fontSize: "13px", color: "#007bff" }}
              onClick={(e) => {
                e.preventDefault();
                setShowPlanAInfo(!showPlanAInfo);
              }}
            >
              More Info
            </a>
            ...
            {showPlanAInfo && (
              <div className="plan-info">
                ...
                <ul>
                  <li>Coverage: ₹5,00,000</li>
                  <li>Hospitalization included</li>
                  <li>Family coverage available</li>
                </ul>
              </div>
            )}
            ...
            <input
              ...
              name="planA"
              placeholder="Plan A"
              value={employeeData.planA}
              onChange={handleChange}
              disabled={!employeeData.planAChecked}
            />
            ...
            <label>
              <input
                type="checkbox"
                name="planBChecked"
                checked={employeeData.planBChecked}
                onChange={handleChange}
              />
              Plan B
            </label>
            ...
            <input
              ...
              name="planB"
              placeholder="Plan B"
              value={employeeData.planB}
              onChange={handleChange}
              disabled={!employeeData.planBChecked}
            />
          </div>

...
const AdminSalesVoucher = () => {
  ...
  return (
    <div className={`sales-container theme-${theme}`}>
      {/* BACKGROUND EFFECTS */}
      ...
      <div className="table-panel">
        ...
        <div className="table-header-row">
          <div>
            <div className="table-title">Sales Voucher</div>
            <div className="table-subtitle">Manage sales vouchers</div>
          </div>
                  ...
                  <tr key={s.id} className="table-row">
                    ...
                    <td>
                      ...
                      >
                        ...
                        <span className="cell-name">{s.customer}</span>
                      </div>
                    </td>
                    ...
                    <td>
                      <span
                        className={`status-pill ${s.status === "Paid" ? "paid" : "pending"}`}
                      >
                        {s.status}
                      </span>
                    </td>

          ...
          <div className="table-header-row">
            <div>
              ...
              <p className="table-subtitle">
                Live overview of connected companies and settlements
              </p>
            </div>
            <button
              className="add-btn"
                        ...
                        <div className="prog-container">
                          ...
                          <div className="prog-track">
                            <div
                              className="prog-fill"
                              style={{
                                width: `${Math.min(100, company.users)}%`,
                                background: colors.progFill,
                              }}
                            ></div>
                          </div>
                        </div>

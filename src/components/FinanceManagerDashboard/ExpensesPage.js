...
const ExpensesPage = () => {
  ...
  return (
    <div className={`expenses-container theme-${theme}`}>
      {/* BACKGROUND EFFECTS */}
      ...
      <div className="table-panel">
        ...
        <div className="table-header-row">
          <div>
            <div className="table-title">Expenses Management</div>
            <div className="table-subtitle">Track and manage all expenses</div>
          </div>
                ...
                filteredExpenses.map((exp) => (
                  <tr key={exp.id} className="table-row">
                    ...
                    <td>
                      ...
                      >
                        <div className="cell-avatar">{exp.title.charAt(0)}</div>
                        <span className="cell-name">{exp.title}</span>
                      </div>
                    </td>
                    ...
                    <td>
                      <span
                        className={`status-pill ${exp.status === "Paid" ? "paid" : "pending"}`}
                      >
                        {exp.status}
                      </span>
                    </td>

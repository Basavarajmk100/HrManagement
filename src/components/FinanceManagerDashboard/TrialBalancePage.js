...
const TrialBalancePage = () => {
  ...
  return (
    <div className={`trial-page theme-${theme}`}>
      {/* BACKGROUND EFFECTS */}
      ...
      <div className="table-panel">
        ...
        <div className="table-header-row">
          <div>
            ...
            <div className="table-subtitle">View debit and credit balances</div>
          </div>
          ...
          <button className="add-btn">Export</button>
        </div>
                  ...
                  <tr key={item.id} className="table-row">
                    ...
                    <td>
                      ...
                      >
                        ...
                        <span className="cell-name">{item.account}</span>
                      </div>
                    </td>
        ...
        {totalDebit !== totalCredit && (
          <div className="error-box">⚠ Debit and Credit are not matching!</div>
        )}
      </div>
    </div>
  );

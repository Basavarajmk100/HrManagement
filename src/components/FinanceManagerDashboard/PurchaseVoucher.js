...
const PurchaseVoucher = () => {
  ...
  const [vouchers, setVouchers] = useState([
    ...
    },
    {
      id: 7,
      voucherNo: "PV-1007",
      vendor: "Bright Office Solutions",
      amount: 3900,
      date: "2026-03-16",
      status: "Paid",
    },
  ...
  return (
    <div className={`purchase-container theme-${theme}`}>
      {/* BACKGROUND EFFECTS */}
      ...
      <div className="table-panel">
        ...
        <div className="table-header-row">
          <div>
            <div className="table-title">Purchase Voucher</div>
            <div className="table-subtitle">Manage purchase vouchers</div>
          </div>
                ...
                filtered.map((v) => (
                  <tr key={v.id} className="table-row">
                    ...
                    <td>
                      ...
                      >
                        <div className="cell-avatar">{v.vendor.charAt(0)}</div>
                        <span className="cell-name">{v.vendor}</span>
                      </div>
                    </td>
                    ...
                    <td>
                      <span
                        className={`status-pill ${v.status === "Paid" ? "paid" : "pending"}`}
                      >
                        {v.status}
                      </span>
                    </td>

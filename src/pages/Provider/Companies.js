...
export default function CompaniesPage() {
  ...
  return (
    <div className={`companies-panel theme-${theme}`}>
      {/* BACKGROUND EFFECTS */}
      ...
      <div className="table-panel theme-light">
        <div className="table-header-row">
          <div>
            <div className="table-title">Companies</div>
          ...
          <table className="styled-table">
            ...
            <tbody>
              {filteredCompanies.length === 0 ? (
                <tr>
                  <td colSpan="14" className="noData">
                    No companies found
                  </td>
                </tr>
              ) : (
                filteredCompanies.map((c) => (
                  <tr className="table-row" key={c.id}>
                    ...
                    <td>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="cell-id">{c.loginId}</div>
                        </div>
                      </div>
                    </td>
                    ...
                    {/* Plan */}
                    <td>
                      <span className="cell-type">{c.plan}</span>
                    </td>
    ...
    <div className="modalOverlay">
      <div className="modal">
        ...
        <div className="modalButtons">
          <button onClick={() => onSave(updated)} className="saveButton">
            Save
          </button>

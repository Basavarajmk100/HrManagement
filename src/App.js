...
import AccessManagement from "./pages/Provider/AccessManagement";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/finance/add-purchase-voucher"
          element={<AddPurchaseVoucher />}
        />

        <Route path="/finance/sales-voucher" element={<SalesVoucher />} />
        <Route
          path="/finance/add-sales-voucher"
          element={<AddSalesVoucher />}
        />
        ...
        <Route
          ...
          element={<EmployeeDashboardPageComponent />}
        />
        ...
        <Route
          path="/employee/request-insurance"
          element={<RequestInsurance />}
        />
        ...
        <Route
          ...
          element={<AddHrStatsPage />}
        />
        <Route
          path="/employee-manager/SalesKPIForm"
          element={<SalesKPIForm />}
        />
        ...
        <Route
          path="/employee-manager/editPayroll/:id"
          element={<EditPayroll />}
        />
        ...
        <Route
          path="/employee-manager/attendance"
        ...
        <Route
          ...
          element={<CreateEmployeeCredentials />}
        />
        ...
        />
        <Route
          path="/employee-manager/EmployeeReport"
        ...
        />
        <Route
          path="/employee-manager/ViewPayslip/:empId"
          element={<ViewPayslip />}
        />
        ...
        <Route
          path="/provider/all-paid-companies"
          element={<AllPaidCompanies />}
        />
        ...
        <Route
          path="/provider/payments/overview"
        ...
        <Route
          path="/provider-dashboard/access-management"
        ...
        <Route
          path="/provider/subscriptions/plans"
          element={<PlanManagement />}
        />
        <Route
          path="/provider/subscriptions/transactions"
          element={<Transactions />}
        />

        <Route
          path="/provider/subscriptions/billing-history"
          element={<BillingHistory />}
        />

        <Route
          path="/provider/dashboard"
          element={<ProviderDashboardSidebar />}
        />
